...
## Exercice 1 sur les dés

![Texte alternatif](images/ex1_de.png) 
...
## Exercice sur les pièces

## Exercice du garagiste

## Exercice 2 sur les dés
...
Dans l'algorithme EM, on commence par estimer de quelle loi proviennent
différents points.

On code ceci à la main avec les points suivants pour s'assurer de la
robustesse de notre méthode : $x_{1} = 0, x_{2} = 5, x_{3} = 12$
...
l'étape actuelle sont proche. Il faut définir un seuil.
